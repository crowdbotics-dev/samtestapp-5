"""
Django settings for samtestapp_5 project.
...
ROOT_URLCONF = 'samtestapp_5.urls'
...
WSGI_APPLICATION = 'samtestapp_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samtestapp_5 API",
    "DESCRIPTION": "API documentation for samtestapp_5 App",
    "VERSION": "v1",
}
